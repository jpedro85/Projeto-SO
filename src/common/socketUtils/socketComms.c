    ...
    do
    {
        ...
        *bufferPointer = readdenChar;
        ...
        if ((totalChars % bufferSize) == 0)
        {
            ...
            {
                fprintf(stderr, "Failed to allocate memory for the strBufferResize.\n");
                free(strReadden);
                return NULL;
            }
